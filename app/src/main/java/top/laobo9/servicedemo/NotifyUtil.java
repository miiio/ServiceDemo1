...
//                requestCode, intent, FLAG);
    ...
    public void notify_progress(PendingIntent pendingIntent, int smallIcon,
                                ...
                                String download_url, String saveDir,String saveName,
         ...
         */
        OkGo.get(download_url)//
                .tag(this)//
                .execute(new FileCallback(saveDir,saveName) {  //文件下载时，可以指定下载的文件目录和文件名
                    @Override
                    public void onSuccess(File file, Call call, Response response) {
                        // file 即为文件数据，文件保存在指定目录
                        cBuilder.setContentText("下载完成").setProgress(0, 0, false);
                        cBuilder.setContentTitle("更新完成...");
                        sent();
                    ...
                    public void downloadProgress(long currentSize, long totalSize, float progress, long networkSpeed) {
                        ...
                        cBuilder.setProgress(100, (int)(progress*100), false);
                        cBuilder.setContentText("下载中...  "+networkSpeed/100+"k/s");
                        sent();
                    }
                });
